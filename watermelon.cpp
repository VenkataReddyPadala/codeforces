...
Pete and Billy are great fans of even numbers, that's why they want to divide
 ...
 tired and want to start their meal as soon as possible, that's why you should help them
  and find out, if they can divide the watermelon in the way they want. For sure, each 
...
""imp test case : if weight is less than 2 we cannot divide it into even number of parts
so weight>2"""
